def get_nvidia_settings() -> dict:
    return {
        ...
        "opengl_image_sharpening_intensity": {
            ...
            "inputs": "value=0, 10=10, 25=25, 35=35, 50=50, 75=75, 100=100",
        ...
        "opengl_image_denoising_intensity": {
            ...
            "inputs": "value=0, 17=17, 25=25, 50=50, 75=75, 100=100",
        ...
        "opengl_heap_allocation_limit": {
            ...
            "inputs": "size=12MB, 20MB=20MB, 50MB=50MB, 100MB=100MB, 200MB=200MB, 500MB=500MB",
        ...
        "opengl_expert_detail_level": {
            ...
            "inputs": "value=0, 1=1, 2=2, 3=3, 4=4",
